...
// void ObjectDisplayGrid::addDisplay (ObjectDisplayGrid *  display) {
//         displays[displayCount++] = display;

// }

// void ObjectDisplayGrid::freeDisplays(){
    
//     for(std::vector<ObjectDisplayGrid *>::iterator display = displays.begin(); display != displays.end(); ++display) { 
//         delete *display; 
//     }
//     displays.clear();
// }